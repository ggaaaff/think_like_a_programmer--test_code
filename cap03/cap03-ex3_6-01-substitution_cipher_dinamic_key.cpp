...
- Function to get a random integer given a range.

  There are two ways:
  The old way - http://www.cplusplus.com/reference/cstdlib/rand/

  The other way - http://www.cplusplus.com/reference/random/
    NOTE: Requieres to use the compiler option: -std=gnu++11



- Using the random number get a letter and eliminate it from an auxiliary array and put it in the new array.
